...
#ea7 - SL-L-S-N-NL-SO-O-NO
#ea8 - SL-L-NL-S-N-SO-O-NO
#ea9 - SL-L-S-NL-N-NO-SO-O
#ea10 - SL-L-S-N-NL-NO-O-SO
...
def estrategiaAdjacencia(posicao_atual, estrategia):
    ...
    if estrategia == "ea1": #ea1 - SL-L-NL-N-NO-O-SO-S
        ...
        return regra
    elif estrategia  == "ea7": #ea6 - SL-L-S-N-NL-SO-O-NO
        regra = [SL,L,S,N,NL,SO,O,NO]
        return regra
    elif estrategia  == "ea8": #ea6 - SL-L-NL-S-N-SO-O-NO
        regra = [SL,L,NL,S,N,SO,O,NO]
        return regra
    elif estrategia  == "ea9": #ea6 - SL-L-S-NL-N-NO-SO-O
        regra = [SL,L,S,NL,N,NO,SO,O]
        return regra
    elif estrategia  == "ea10": #ea6 - SL-L-S-N-NL-NO-O-SO
        regra = [SL,L,S,N,NL,NO,O,SO]
        return regra
    else:
